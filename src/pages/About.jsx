      ...
      <div id='home' className='w-screen h-screen flex flex-col justify-center items-center mb-20 bg-banner bg-cover bg-center'>
        <div className='grid grid-cols-2 m-10'>
          <div className='flex flex-col items-center justify-center'>
            <img className='rounded-full border h-80' src="src/assets/images/profile.jpeg" alt="profile" />
          </div>
          <div className='w-auto grid grid-cols-1 items-center justify-center text-right p-6 text-white border rounded-lg bg-slate-800 bg-opacity-20 hover:scale-105 transition-transform'>
            ...
            <div className='flex flex-row justify-end mb-2'>
              <a href="https://github.com/logankm02"><img className='h-10 m-2' src="src/assets/images/github.png" alt="git" /></a>
              <a href="https://www.linkedin.com/in/logan-kinajil-moran/"><img className='h-10 m-2' src="src/assets/images/linkedin.png" alt="linkedin" /></a>
            </div>
        ...
        <a href="#about" className='flex items-center justify-center' onClick={handleScrollAbout}><img className='w-14' src="src/assets/images/arrow.png" alt="arrow" /></a>
      </div>
        <div id='about' className='flex flex-col justify-center h-max'>
          ...
          <div className='flex flex-row items-center space-x-4 border p-8 rounded-md bg-slate-50 mb-10 hover:scale-105 transition-transform'>
            <img className='h-20' src="src/assets/images/r.png" alt="R"/>
            <div>
        ...
        <div className='flex flex-col justify-center mb-10'>
          ...
          <div className='grid grid-cols-7'>
            ...
            <div className='skill'>
              <img src="src/assets/images/clogo.png" alt="c" />
              <p>C</p>
            </div>
            <div className='skill'>
              <img src="src/assets/images/jslogo.png" alt="js" />
              <p>JavaScript</p>
            </div>
            <div className='skill'>
              <img src="src/assets/images/swift.png" alt="swift" />
              <p>Swift</p>
            </div>
            <div className='skill'>
            ...
            <div className='skill'>
              <img src="src/assets/images/sqllogo.png" alt="sql" />
              <p>SQL</p>
            </div>
            <div className='skill'>
            ...
            <div className='skill'>
              <img src="src/assets/images/threejs.png" alt="threejs" />
              <p>Three.js</p>
            </div>
            <div className='skill'>
            ...
            <div className='skill'>
              <img src="src/assets/images/mongodb.svg" alt="mongodb" />
              <p>MongoDB</p>
            </div>
          </div>
        </div>
